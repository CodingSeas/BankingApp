...
public class Activity_Shubhendra extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyDbHandler db = new MyDbHandler(Activity_Shubhendra.this);
        listView = findViewById(R.id.listView);

        ArrayList<String> customers = new ArrayList<>();
        List<Customer> AllCustomers = db.getCustomer(10);
