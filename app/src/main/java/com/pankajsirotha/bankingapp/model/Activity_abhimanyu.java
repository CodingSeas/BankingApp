...
import com.pankajsirotha.bankingapp.viewallcustomer;

import java.util.ArrayList;
import java.util.List;

public class Activity_abhimanyu extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyDbHandler db = new MyDbHandler(Activity_abhimanyu.this);
        listView = findViewById(R.id.listView);

        ArrayList<String> customers = new ArrayList<>();
        List<Customer> AllCustomers = db.getCustomer(4);
